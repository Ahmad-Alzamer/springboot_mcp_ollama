source URL: https://docs.spring.io/spring-ai/reference/api/docker-compose.html 
...
to a model service or vector store running via Docker Compose. To enable it, add
